...
namespace MoreMountains.HighroadEngine
{
    ...
    public class NetworkVehicleController : MonoBehaviour, INetworkVehicle
    {
        ...
        public virtual void Update()
        {
            if (!_initialized)
            {
                ...
                if (isLocalPlayer)
                {
                    ...
                    if (_networkRaceManager != null)
                    {
                        ...
                        _networkRaceManager.RaceManager.InitRespawnButton(this.gameObject);
            ...
            if (isLocalPlayer)
            {
                ...
                if (_initialized && _controller.IsPlaying)
                {
                    ...
                    if (_networkRaceManager.RaceManager.ClosedLoopTrack)
                    {
                    ...
                    {
                        _networkRaceManager.RaceManager.ScoreText3.text = "";
                    }
                }
            }
            else
