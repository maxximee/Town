...
namespace MoreMountains.HighroadEngine
{
    ...
    public class VehicleAI : MonoBehaviour
    {
        ...
        [MMInformation("To help the AI, vehicles can have a better steering and max speed than usual.", MMInformationAttribute.InformationType.Info, false)]
        public bool OverrideSteringAndMaxSpeed = false;
        public int SteeringSpeed = 300;
        public int MaxSpeed = 300;
        public int EnginePower = 30000;
        ...
        protected RaycastHit _shootTarget;

        protected Boolean waitedSomeTime = true;
        ...
        public virtual void OnDrawGizmos()
        {
            ...
            Gizmos.DrawLine(transform.position, _shootTarget.point);
