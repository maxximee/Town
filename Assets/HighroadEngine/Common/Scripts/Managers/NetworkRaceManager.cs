...
{
    /// <summary>
    /// If the game is an online UNet game, this class overrides methods from Race Manager to manage specific 
    /// online parts.
    ...
    public class NetworkRaceManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Disables the control for a player.
        /// </summary>
        
        public virtual void DisableControlForPlayer(BaseController controller)
        {
            NetworkVehicleController car = controller.GetComponent<NetworkVehicleController>();
            if (car != null)
            {
